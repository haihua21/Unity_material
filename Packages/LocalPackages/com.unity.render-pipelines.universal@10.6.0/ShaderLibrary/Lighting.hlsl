...
//#pragma multi_compile _ _SUBTRACTIVE_ADDITIONAL_LIGHTING
    ...
    half3 normalWS, half3 viewDirectionWS)
{
    ...
    half3 indirectDiffuse = bakedGI * occlusion * _IndirectDiffuseColor.rgb * _IndirectDiffuseIntensity;
    half3 indirectSpecular = GlossyEnvironmentReflection(reflectVector, brdfData.perceptualRoughness, occlusion) * _IndirectSpecularColor.rgb * _IndirectSpecularIntensity;
...
/*    
    ...
    color += brdfData.specular * DirectBRDFSpecular(brdfData, inputData.normalWS, mainLight.direction, inputData.viewDirectionWS);
#endif
*/
