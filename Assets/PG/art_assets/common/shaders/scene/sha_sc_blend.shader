...
Shader "ase/scene/sha_sc_blend"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float CalcSSAO23_g726( float2 position_cs, float3 main_light_color, float input_ao, out float3 main_light_color_ssao )
			{
			...
			float3 MixRealtimeAndBakedGI167_g725( float3 normalWS, float3 bakedGI, float3 positionWS )
			{
			...
			float3 AdditionalLighting14_g727( float3 position_ws, float3 normal_ws, float3 normal_normalized_ws, float3 view_dir_ws, float3 diffuse, float3 specular, float roughness2_minus_one, float roughness2, float normalization_term, float shadow_mask )
			{
				float3 color = 0;
				// 像素光
			...
			float3 MyCustomExpression16_g724( float direct_specular_color )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float input_metallic11_g725 = surface_metallic71;
				float func_brdf_metallic9_g731 = input_metallic11_g725;
				float func_brdf_one_minus_reflectivity16_g731 = ( _kDielectricSpec.w - ( _kDielectricSpec.w * func_brdf_metallic9_g731 ) );
				...
				float3 tangentToViewDir8_g544 = ASESafeNormalize( mul( UNITY_MATRIX_V, float4( mul( ase_tangentToWorldFast, surface_normal_ts14 ), 0 ) ).xyz );
				float3 matcap_uv20 = ( ( tangentToViewDir8_g544 * 0.5 ) + 0.5 );
				...
				float3 input_albedo7_g725 = surface_albedo31.rgb;
				float3 func_brdf_albedo8_g731 = input_albedo7_g725;
				float3 func_brdf_diffuse23_g731 = ( func_brdf_one_minus_reflectivity16_g731 * func_brdf_albedo8_g731 );
				float3 brdf_diffuse61_g725 = func_brdf_diffuse23_g731;
				float3 func_brdf_dielectric_spec29_g731 = (_kDielectricSpec).xyz;
				float3 lerpResult24_g731 = lerp( func_brdf_dielectric_spec29_g731 , func_brdf_albedo8_g731 , func_brdf_metallic9_g731);
				float3 func_brdf_specular31_g731 = lerpResult24_g731;
				float3 brdf_specular41_g725 = func_brdf_specular31_g731;
				...
				float input_smoothness12_g725 = surface_smoothness70;
				float func_brdf_smoothness11_g731 = input_smoothness12_g725;
				float func_brdf_perceptual_roughness35_g731 = ( 1.0 - func_brdf_smoothness11_g731 );
				float func_brdf_roughness40_g731 = max( ( func_brdf_perceptual_roughness35_g731 * func_brdf_perceptual_roughness35_g731 ) , 0.0078125 );
				float func_brdf_roughness244_g731 = max( ( func_brdf_roughness40_g731 * func_brdf_roughness40_g731 ) , 6.103516E-05 );
				float brdf_roughness234_g725 = func_brdf_roughness244_g731;
				...
				float3 temp_output_5_0_g725 = surface_normal_ws86;
				float3 normalizeResult10_g725 = ASESafeNormalize( temp_output_5_0_g725 );
				float3 input_normal_normalized_ws9_g725 = normalizeResult10_g725;
				float3 temp_output_21_0_g730 = input_normal_normalized_ws9_g725;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 temp_output_3_0_g730 = ase_worldViewDir;
				float3 temp_output_4_0_g730 = SafeNormalize(_MainLightPosition.xyz);
				float3 normalizeResult19_g730 = ASESafeNormalize( ( temp_output_3_0_g730 + temp_output_4_0_g730 ) );
				float dotResult13_g730 = dot( temp_output_21_0_g730 , normalizeResult19_g730 );
				float NoH11_g730 = saturate( dotResult13_g730 );
				float vector_NoH31_g725 = NoH11_g730;
				float temp_output_1_0_g733 = vector_NoH31_g725;
				float func_brdf_roughness2_minus_one52_g731 = ( func_brdf_roughness244_g731 - 1.0 );
				float brdf_roughness2_minus_one32_g725 = func_brdf_roughness2_minus_one52_g731;
				float temp_output_8_0_g733 = ( ( ( temp_output_1_0_g733 * temp_output_1_0_g733 ) * brdf_roughness2_minus_one32_g725 ) + 1.00001 );
				float dotResult8_g730 = dot( normalizeResult19_g730 , temp_output_4_0_g730 );
				float HoL1_g730 = saturate( dotResult8_g730 );
				float vector_HoL29_g725 = HoL1_g730;
				float temp_output_3_0_g733 = vector_HoL29_g725;
				float func_brdf_normalization_term49_g731 = ( ( func_brdf_roughness40_g731 * 4.0 ) + 2.0 );
				float brdf_normalization_term33_g725 = func_brdf_normalization_term49_g731;
				float direct_brdf_specular50_g725 = ( brdf_roughness234_g725 / ( ( temp_output_8_0_g733 * temp_output_8_0_g733 ) * ( max( ( temp_output_3_0_g733 * temp_output_3_0_g733 ) , 0.1 ) * brdf_normalization_term33_g725 ) ) );
				float3 temp_output_66_0_g725 = ( brdf_specular41_g725 * direct_brdf_specular50_g725 );
				#ifdef _SPECULARHIGHLIGHTS_ON
				float3 staticSwitch116_g725 = ( brdf_diffuse61_g725 + temp_output_66_0_g725 );
				#else
				float3 staticSwitch116_g725 = brdf_diffuse61_g725;
				#endif
				float4 input_position_cs139_g725 = half4(0,0,0,0);
				float2 position_cs23_g726 = input_position_cs139_g725.xy;
				float3 main_light_color23_g726 = _MainLightColor.rgb;
				float input_ao13_g725 = 1.0;
				float input_ao23_g726 = input_ao13_g725;
				float3 main_light_color_ssao23_g726 = float3( 1,1,1 );
				float localCalcSSAO23_g726 = CalcSSAO23_g726( position_cs23_g726 , main_light_color23_g726 , input_ao23_g726 , main_light_color_ssao23_g726 );
				float3 main_light_color_ssao144_g725 = main_light_color_ssao23_g726;
				float ase_lightAtten = 0;
				Light ase_lightAtten_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_lightAtten_mainLight.distanceAttenuation * ase_lightAtten_mainLight.shadowAttenuation;
				float func_attenuation171_g725 = ase_lightAtten;
				float dotResult16_g730 = dot( temp_output_21_0_g730 , temp_output_4_0_g730 );
				float NoL20_g730 = saturate( dotResult16_g730 );
				float vector_NoL52_g725 = NoL20_g730;
				float3 radiance73_g725 = ( main_light_color_ssao144_g725 * func_attenuation171_g725 * vector_NoL52_g725 );
				float3 direct_color91_g725 = ( staticSwitch116_g725 * radiance73_g725 );
				float3 normalWS167_g725 = input_normal_normalized_ws9_g725;
				float3 bakedGI108_g725 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, input_normal_normalized_ws9_g725);
				float3 bakedGI167_g725 = bakedGI108_g725;
				float3 positionWS167_g725 = WorldPosition;
				float3 localMixRealtimeAndBakedGI167_g725 = MixRealtimeAndBakedGI167_g725( normalWS167_g725 , bakedGI167_g725 , positionWS167_g725 );
				float input_ao_ssao143_g725 = localCalcSSAO23_g726;
				float3 indirect_diffuse_color78_g725 = ( localMixRealtimeAndBakedGI167_g725 * brdf_diffuse61_g725 * input_ao_ssao143_g725 );
				ase_worldViewDir = normalize(ase_worldViewDir);
				half3 reflectVector109_g725 = reflect( -ase_worldViewDir, input_normal_normalized_ws9_g725 );
				float3 indirectSpecular109_g725 = GlossyEnvironmentReflection( reflectVector109_g725, 1.0 - input_smoothness12_g725, input_ao_ssao143_g725 );
				float func_brdf_reflectivity20_g731 = ( 1.0 - func_brdf_one_minus_reflectivity16_g731 );
				float func_brdf_grazing_term57_g731 = saturate( ( func_brdf_smoothness11_g731 + func_brdf_reflectivity20_g731 ) );
				float brdf_grazing_term37_g725 = func_brdf_grazing_term57_g731;
				float3 temp_cast_6 = (brdf_grazing_term37_g725).xxx;
				float dotResult14_g730 = dot( temp_output_21_0_g730 , temp_output_3_0_g730 );
				float NoV2_g730 = saturate( dotResult14_g730 );
				float vector_NoV28_g725 = NoV2_g730;
				float temp_output_42_0_g725 = ( 1.0 - vector_NoV28_g725 );
				float3 lerpResult8_g729 = lerp( brdf_specular41_g725 , temp_cast_6 , ( temp_output_42_0_g725 * temp_output_42_0_g725 * temp_output_42_0_g725 * temp_output_42_0_g725 ));
				float3 indirect_specular_term59_g725 = ( ( 1.0 / ( brdf_roughness234_g725 + 1.0 ) ) * lerpResult8_g729 );
				float3 indirect_specular_color74_g725 = ( indirectSpecular109_g725 * indirect_specular_term59_g725 );
				float3 indirect_color92_g725 = ( indirect_diffuse_color78_g725 + indirect_specular_color74_g725 );
				float3 position_ws14_g727 = WorldPosition;
				float3 input_normal_ws8_g725 = temp_output_5_0_g725;
				float3 normal_ws14_g727 = input_normal_ws8_g725;
				float3 normal_normalized_ws14_g727 = input_normal_normalized_ws9_g725;
				float3 view_dir_ws14_g727 = ase_worldViewDir;
				float3 diffuse14_g727 = brdf_diffuse61_g725;
				float3 specular14_g727 = brdf_specular41_g725;
				float roughness2_minus_one14_g727 = brdf_roughness2_minus_one32_g725;
				float roughness214_g727 = brdf_roughness234_g725;
				float normalization_term14_g727 = brdf_normalization_term33_g725;
				float shadow_mask14_g727 = 1;
				float3 localAdditionalLighting14_g727 = AdditionalLighting14_g727( position_ws14_g727 , normal_ws14_g727 , normal_normalized_ws14_g727 , view_dir_ws14_g727 , diffuse14_g727 , specular14_g727 , roughness2_minus_one14_g727 , roughness214_g727 , normalization_term14_g727 , shadow_mask14_g727 );
				float3 additional_color90_g725 = localAdditionalLighting14_g727;
				...
				float3 input_emission15_g725 = surface_emission_color126;
				float3 direct_specular_color127_g725 = temp_output_66_0_g725;
				float direct_specular_color16_g724 = direct_specular_color127_g725.x;
				float3 localMyCustomExpression16_g724 = MyCustomExpression16_g724( direct_specular_color16_g724 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( direct_color91_g725 + indirect_color92_g725 + additional_color90_g725 + input_emission15_g725 ) + localMyCustomExpression16_g724 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18912
2041.6;156.8;2048;967.8;658.3766;292.1325;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;117;-2128.545,2370.106;Inherit;False;Property;_ReflectionAmount;ReflectionAmount;21;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateFragmentDataNode;174;54.12341,420.7675;Inherit;False;0;0;clipPos;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-2554.924,-181.0837;Inherit;False;Property;_MatcapIntensity;MatcapIntensity;19;0;Create;True;0;0;0;False;0;False;1.5;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-2726.376,3588.61;Inherit;False;11;uv;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;105;-2607.051,-1203.968;Inherit;False;sha_com_func_matcap_uv;-1;;544;b00a8b7be669c054e8bc5f643d726043;0;1;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;221;313.4636,32.75439;Inherit;False;sha_sc_func_base_pbr_lighting;24;;724;b007fbbd74b41fb44ad54b3f89e16d09;0;7;2;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;6;FLOAT;0;False;1;FLOAT;0;False;5;FLOAT;0;False;39;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-2571.646,1032.002;Inherit;False;Property;_G_Color_Metallic;G_Color_Metallic;8;0;Create;True;0;0;0;False;0;False;0;0.053;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-3010.812,1522.186;Inherit;False;Property;_A_Color_Smoothness;A_Color_Smoothness;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-2165.528,1691.897;Inherit;False;Property;_R_Color_Smoothness;R_Color_Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0.085;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;6;-2839.286,-1593.649;Inherit;False;Property;_Tex_Tile;Tex_Tile;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;84;-1639.437,916.7397;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-2940.727,-460.3513;Inherit;True;Property;_MatcapMap;Matcap Map;18;0;Create;True;0;0;0;False;0;False;-1;None;e834e2fa15fba064380d2ffb98cc5c97;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;38;-2091.01,309.3796;Inherit;False;Property;_R_Color;R_Color;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6603774,0.1464043,0.2736347,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;37;-2559.617,328.4278;Inherit;False;Property;_G_Color;G_Color;6;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.737255,0.2274508,0.3622316,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;36;-3092.948,308.6938;Inherit;False;Property;_B_Color;B_Color;9;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;111;-2423.788,2980.038;Inherit;False;Property;_EmissionColor;Emission Color;16;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SwizzleNode;15;-2379.01,-923.7479;Inherit;False;FLOAT3;0;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;35;-3102.948,121.6939;Inherit;False;Property;_A_Color;A_Color;12;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-2570.753,1687.052;Inherit;False;Property;_G_Color_Smoothness;G_Color_Smoothness;7;0;Create;True;0;0;0;False;0;False;0;0.009;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1864.912,-137.9805;Inherit;False;Property;_BlendMapcap;BlendMapcap;20;0;Create;True;0;0;0;False;0;False;0;0.889;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-3008.753,1608.052;Inherit;False;Property;_B_Color_Smoothness;B_Color_Smoothness;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;221;2;89;0
WireConnection;221;4;88;0
WireConnection;221;3;127;0
WireConnection;221;6;90;0
WireConnection;221;1;91;0
WireConnection;221;5;92;0
WireConnection;221;39;174;0
...
WireConnection;2;2;221;0
ASEEND*/
//CHKSM=59691E923BF5FE4C3F084BDE7E19EC958EE6C4EA