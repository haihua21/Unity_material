	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float Alpha = _Float0;
				float AlphaClipThreshold = ( ase_lightAtten * 2.0 );
...
ASEEND*/
//CHKSM=0383B46E30EDC1CEFAC4CDA7FA2AD63D2D7035FC