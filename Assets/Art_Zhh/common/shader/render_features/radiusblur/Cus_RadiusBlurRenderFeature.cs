...
public class Cus_RadiusBlurRenderFeature : ScriptableRendererFeature  //RenderFeature中显示名称
{
    [System.Serializable]
    ...
    Cus_RadiusBlurPass pass;                                                       //设置渲染Pass
    public override void Create()                                  
    {
        this.name = "Cus_RadiusBlurPass";                                         
        pass = new Cus_RadiusBlurPass(RenderPassEvent.BeforeRenderingPostProcessing, settings.shader);
